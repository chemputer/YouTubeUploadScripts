...
if __name__ == '__main__':
  argparser.add_argument("--file", default="" help="Video file to upload")
  argparser.add_argument("--title", default="" help="Video title")

  # changed default video description to just be blank.
  argparser.add_argument("--description", default ="" help="Video description")

  # changed default category to 20, gaming.
  ...
  argparser.add_argument("--keywords", help="Video keywords, comma separated",
    default="")
      ...
      # changed default from public to unlisted
  argparser.add_argument("--privacyStatus", choices=VALID_PRIVACY_STATUSES,
    default=VALID_PRIVACY_STATUSES[2], help="Video privacy status.") 
  args = argparser.parse_args()

  if args.file == None or args.file is "":
      root = tk.Tk()
      root.withdraw()
      args.file = filedialog.askopenfilename()

  if args.title is "" or args.description is "" or args.description == None or args.title == None:
      root = tk.Tk()
      root.withdraw()
      args.title = tk.simpledialog.askstring("Video Title", "Please enter a title for the video:")
      args.description = tk.simpledialog.askstring("Video Description", "Please enter a description for the video:")
